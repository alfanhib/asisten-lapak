  ...
  getAllData() {
    ...
    axios
      .get(
        `${
          config.uri
        }/data/transactions?where=status%20%3D%20'pending'&props=name%2Caddress%2Ccreated&loadRelations=typeOfShipping`
      )
      .then(transactions => {
    ...
    return (
      <Container>
                      ...
                      <View style={{ flex: 1, paddingLeft: 10 }}>
                        ...
                        <View style={{ flexDirection: "row" }}>
                          ...
                          <Text style={styles.rowTextSender}>
                            {transaction.typeOfShipping.name}
                          </Text>
                        </View>
                      </View>
                    </View>
        ...
        <Fab
          ...
          onPress={() => this.props.navigation.navigate("CsTransactionAdd")}
        >
          <Icon name="add" />
        </Fab>
      </Container>
